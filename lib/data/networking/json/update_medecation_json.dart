...
class UpdateMedecationsJson extends AbstractJsonResource {
  int? status;
  String? message;
  Data? data;

  UpdateMedecationsJson({this.status, this.message, this.data});

  UpdateMedecationsJson.fromJson(Map<String, dynamic> json) {
    status = json['status'];
