...
class GetAlertBySeizureJson extends AbstractJsonResource{
  int? status;
  String? message;
  List<Data>? data;

  GetAlertBySeizureJson({this.status, this.message, this.data});

  GetAlertBySeizureJson.fromJson(Map<String, dynamic> json) {
    status = json['status'];
