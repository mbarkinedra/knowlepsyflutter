...
class AddStateMedicationJson extends AbstractJsonResource {
  int? status;
  String? message;
  Data? data;

  AddStateMedicationJson({this.status, this.message, this.data});

  AddStateMedicationJson.fromJson(Map<String, dynamic> json) {
    status = json['status'];
